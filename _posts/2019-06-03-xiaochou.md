...
image: http://qvcm83j7n.hn-bkt.clouddn.com/godfather.jpg
category: 音乐
tags: 
  - 翻唱
  - 毛不易
...
<div class="audio">
  <audio id="audio-xiaochou" controls loop preload="auto">
    <source src="http://qvcm83j7n.hn-bkt.clouddn.com/xiaochou.mp3" type="audio/mpeg">
  </audio>
  <div id="lyrics-xiaochou">
  </div>
  <script type="module">
    import RabbitLyrics from "/assets/js/rabbit-lyrics.js";
    $.get("http://qvcm83j7n.hn-bkt.clouddn.com/xiaochou.lrc", function(data, status) {
