...
image: http://qtztjl6lf.hn-bkt.clouddn.com/puppet.jpeg
category: 音乐
tags: 
  - 翻唱
  - 陈奕迅
...
<div class="audio">
  <audio id="audio-clear" controls loop preload="auto">
    <source src="http://qtztjl6lf.hn-bkt.clouddn.com/clear.mp3" type="audio/mpeg">
  </audio>
  <div id="lyrics-clear">
  </div>
  <script type="module">
    import RabbitLyrics from "/assets/js/rabbit-lyrics.js";
    $.get("http://qtztjl6lf.hn-bkt.clouddn.com/clear.lrc", function(data, status) {
